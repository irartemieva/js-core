...
function isAcceptablePassword2(password) {
    // your code here
...
function isAcceptablePassword3(password) {
    // your code here
...
function isAcceptablePassword4(password) {
    // your code here
...
function isAcceptablePassword5(password) {
    // your code here
    const pswdLength = password.length > 6;
    const pswdNumbers = /\d/.test(password);
    const pswdLetters = /[A-Za-z]/.test(password);
    if (password.toLocaleLowerCase().indexOf('password') !== -1)
        return !password;
    if (password.length > 9) {
        return pswdLength;
    }
...
function isAcceptablePassword6(password) {
    // your code here
    const pswdLength = password.length > 6;
    const pswdNumbers = /\d/.test(password);
    const pswdLetters = /[A-Za-z]/.test(password);
...
function betweenMarkers(text, start, end) {
    // your code here
    let result = text.substring(text.indexOf(start) + 1, text.indexOf(end));
    return result;
}
console.log("Example:");
